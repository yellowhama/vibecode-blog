...
| What | Where |
|---|---|
| **This index** | `content/video/VIDEO_PRODUCTION_INDEX.md` |
| **Content evaluation framework** | `content/video/planning/CONTENT_EVALUATION_FRAMEWORK.md` |
| **Pipeline scripts** | `content/video/pipeline/scripts/` |
| **Audio catalog** | `content/video/pipeline/audio_catalog.json` |
| **Preproduction runs** | `content/video/preproduction/` |
| **Render outputs** | `content/video/output/renders/` |
| **YouTube packages** | `content/video/output/youtube_packages/` |
| **Visual assets guide** | `content/video/planning/03-visual_assets_guide.md` |
| **Animation directing guide** | `content/video/planning/04-animation_directing_guide.md` |
